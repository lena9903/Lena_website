...
overlayEl.style.setProperty("--icon-cols", cols);
  ...
  // بالآيباد/اللابتوب (لما شاشة اللابتوب المرسومة فعلياً على الشاشة
  // عريضة بما فيه الكفاية)، نغيّر ترتيب الفولدرات حتى Skills وContact
  // ينزلوا للصف التاني — الجوال يضل بترتيبه الأصلي بدون أي تغيير
